...
Map<String, String> EnglishToSimplifiedChinese = {
  ...
  'Edit': '编辑',
  'Amount:':'数量',
  'Track items\' usage': '查询物品',
  'Lost and found': "失物招领",
  "Language Setting": '语言',
  'Location Managers are not granted to change the access control of Admins': '区域管理者无权对最终管理者权限进行修改',
  'Location Managers are not granted to change the access control of other Managers': '区域管理者无权对其他区域管理者进行修改',
  'Contact us': '联系我们',
  'Light': '浅色',
  'Dark': '深色',
  'By System Default Setting': '自动',
  'Manage category': '编辑类别',
  'Please choose ONE of the options below to add items:' : '请从以下两项中选择一项来进行物品的添加',
  'Manaually': '手动添加',
  'Upload CSV':'上传CSV',
  'OnHold items': '待上传物品',
  ' Orders': '订单',
  'Type the item name here': '在此输入物品名称',
  'Selected item:': '选择的物品为',
  'Search orders at ': '搜索物品在',
  'Search for people':'搜索用户',
  'Type the person\'s name here': '在此输入用户名字',
  'Type the person\'s email address here':'在此输入用户邮箱',
  'Describe the item and leave your contact': '请描述你丢失的物品并留下您的联系方式',
  'In Use': '使用中',
  'Done': "完成",
  'Pickup': '领取',
  'Return': '归还',
  'Category:': '类别',
  'click to edit reservation amount': '点击以更改预订数量',
  'The item you have selected is currently not available.': '您选择的物品已被预订 请稍等片刻',
